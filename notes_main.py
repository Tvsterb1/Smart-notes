...
def show_credits():
    txt = QMessageBox()
    txt.setWindowTitle("Credits")
    txt.setText("<center>Made by Tvsterb1<br><a href='https://github.com/Tvsterb1'>https://github.com/Tvsterb1</a><br>MIT License<br>Copyright (c) 2024 Tvsterb1</center>")
    txt.show()
    txt.exec_()
